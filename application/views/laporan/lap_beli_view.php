                                    ...
                                    <!-- <?php 
                                        foreach ($obat as $data) {
                                            echo '
                                                ...
                                                <td>'.$data->harga.'</td>
                                                <td>
                                                <a href="'.base_url().'index.php/obat/edit_obat/'.$data->id_obat.'" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-search"></i> Edit </a>
                                                <a href="'.base_url().'index.php/buku/hapus/'.$data->id_obat.'" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Hapus </a>
                                                </td>
                                                </tr>
                                                ';
                                            }
